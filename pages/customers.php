...
<div class="col-md-4">
	<h2 class="form-signin-heading">Customers</h2>
</div>
...
<script>
	$(function() {
          ...
          $('#data_table').load('<?=root()?>exec/customers/?search='+$('#livesearch').val()+' #data_table');
			});
	});
</script>
...
<div class="col-md-2 text-right"><br />
	...
	<button class="btn btn-success" onclick="document.location='<?=root()?>?page=add_customer';">Add Customer</button>
</div>
<div class="clear"></div>
...
<script>
    $(document).ready(function(){
        ...
        $('#datatable tbody').on( 'click', 'tr', function () {
            ...
            document.location.href = "<?php echo root();?>?page=edit_customer&id=" + redirection;
        });
    })
</script>