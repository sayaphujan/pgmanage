                                ...
                                if($order_options['em'.$i.'_1'] != 'None')
                                {
                                    ...
                                    echo '<div class="col-sm-5 box">';
                                                    if(preg_match('/Custom Logo/', $order_options['em'.$i.'_1']))
                                                    {
                                                        ...
                                                        $logo = "<img src='".$logo."' width='300px'>";
                                                        $link = 'https://'.$des.'/images/upload/'.$order_options['img-em'.$i.'_1'];
                                                    }
                                                    //else if(preg_match('/Custom Text/', $order_options['em'.$i.'_1']))
                                                    else
                                                    {
                                                        $logo = file_get_contents('https://'.$des.'zip/'.$p.'_order_'.$order_id.'/em'.$i.'_'.$order_id.'.svg?time='.time());
                                                                                        ...
                                                                                        if($order_options['new_falkyn'] == 'true')
                                                                                        {
                                                                                            if(preg_match('/F TATTOO/', $order_options['em'.$i.'_1']))
                                                                                            {
                                                                                                 echo '
                                                                                                            ...
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle7-1-ft'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 2
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle6-1-ft'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 3
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle5-1-ft'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 4
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle4-1-ft'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 5
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle8-1-ft'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 6
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle2-1-ft'].'</p>
                                                                                                            <br/>
                                                                                                        ';
                                                                                            }
                                                                                            else if(preg_match('/PMI TATTOO/', $order_options['em'.$i.'_1']))
                                                                                            {
                                                                                                 echo '
                                                                                                            <p class="lead measure">Color 1
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle3-1-pmi'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 2
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle5-1-pmi'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 3
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle4-1-pmi'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 4
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle2-1-pmi'].'</p>
                                                                                                            <br/>
                                                                                                        ';
                                                                                            }
                                                                                            else if(preg_match('/FALKYN/', $order_options['em'.$i.'_1']))
                                                                                            {
                                                                                                  echo '
                                                                                                            <p class="lead measure">Color 1
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle3-1-fk'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 2
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle2-1-fk'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 3
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle7-1-fk'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 4
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle4-1-fk'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 5
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle13-1-fk'].'</p>
                                                                                                            <br/>
                                                                                            ...
                                                                                            else if(preg_match('/F/', $order_options['em'.$i.'_1']))
                                                                                            {
                                                                                                echo '
                                                                                                            <p class="lead measure">Color 1
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle2-1-ff'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 2
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle6-1-ff'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 3
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle7-1-ff'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 4
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle8-1-ff'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 5
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle3-1-ff'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 6
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle4-1-ff'].'</p>
                                                                                                            <br/>
                                                                                                            <p class="lead measure">Color 7
                                                                                                            &nbsp;&nbsp;:&nbsp; '.$order_options['em'.$i.'_needle5-1-ff'].'</p>
                                                                                                            <br/>
                                                                                                        ';
                                                                                            }
                                                                                        }
