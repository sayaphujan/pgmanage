...
?>
<div class="col-md-3">
	<h2 class="form-signin-heading">New Orders</h2>
</div>
...
<tr>
	...
	<th width="30%"><a href="<?=root()?>?page=masks&order_status=<?=$_GET['order_status']?>&order_by=id">Order Date</th>
	...
	<th><a href="<?=root()?>?page=masks&order_status=<?=$_GET['order_status']?>&order_by=order_total">Order Total</a></th>
</tr>
