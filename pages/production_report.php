...
<div class="project_heading" style="padding-top: 25px">
    <div class="col-md-1 text-right project-edit-btn no-print">
		...
		<button class="btn" onclick="location.href='?page=print_report'">Production Archive</button>
...
if(empty($_GET['cycle'])) {
	...
	echo '<br />
	<h4>Please select an active production cycle</h4><br />
	<br />
	 <div id="data_table">
	...
	while($project = mysqli_fetch_assoc($q)) {
		...
		if(!in_array($pod_output[0], $pods) && !empty($pod_output[0])) {
			...
			echo '<tr><td>'.$no++.'</td><td><a href="?page=production_report&cycle='.$pod_output[0].'">'.$pod_output[0].'</td></tr>';
...
<ul class="nav nav-tabs no-print">
	...
	<li class="active"><a data-toggle="tab" href="#harness">Harness</a></li>

	<li ><a data-toggle="tab" href="#lateral">Lateral</a></li>
	
	<li ><a data-toggle="tab" href="#teamc">Team C</a></li>
	
</ul>

<div class="tab-content">
	<div id="harness" class="tab-pane fade in active">
		<table class="table">
			<tr>
				<th>Serial</th>
				<th>MLW Config</th>
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td align="center"><input size="6" type="text" class="field_update key" name="hw_batch_lot_1_harness-'.$c['id'].'" data-var="harness" data-id="'.$c['id'].'" data-tab="1" value="'.$vars[3]['vars']['hw_batch_lot_1_harness'].'"></td>
					<td>'.$vars[1]['vars']['Webbing Color'].'</td>
					<td align="center"><input size="6" type="text" class="field_update key" name="wb7_batch_lot_1_harness-'.$c['id'].'" data-var="harness" data-id="'.$c['id'].'" data-tab="1" value="'.$vars[3]['vars']['wb7_batch_lot_1_harness'].'"></td>
					<td>'.$vars[1]['vars']['Webbing Color'].'</td>
					<td align="center"><input size="6" type="text" class="field_update key" name="wb8_batch_lot_1_harness-'.$c['id'].'" data-var="harness" data-id="'.$c['id'].'" data-tab="1" value="'.$vars[3]['vars']['wb8_batch_lot_1_harness'].'"></td>
					<td>'.$vars[1]['vars']['Webbing Color'].'</td>
					<td align="center"><input size="6" type="text" class="field_update key" name="t7_batch_lot_1_harness-'.$c['id'].'" data-var="harness" data-id="'.$c['id'].'" data-tab="1" value="'.$vars[3]['vars']['t7_batch_lot_1_harness'].'"></td>
					<td>'.$vars[1]['vars']['Webbing Color'].'</td>
					<td align="center"><input size="6" type="text" class="field_update key" name="t8_batch_lot_1_harness-'.$c['id'].'" data-var="harness" data-id="'.$c['id'].'" data-tab="1" value="'.$vars[3]['vars']['t8_batch_lot_1_harness'].'"></td>
					<td>'.$vars[1]['vars']['Chest Strap Type'].'</td>
					<td>'.$vars[1]['vars']['Leg Pad Size'].'</td>
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_1_harness'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" data-var="harness" data-tab="1" name="cut_ready_1_harness-'.$c['id'].'" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_1_harness'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" data-var="harness" data-tab="1" name="production_complete_1_harness-'.$c['id'].'" type=\'checkbox\'></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
			}
	...
	<div id="lateral" class="tab-pane fade">
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td>'.$vars[1]['vars']['Webbing Color'].'</td>
					<td>'.$vars[1]['vars']['Webbing Color'].'</td>
					<td align="center"><input size="6" type="text" class="field_update key" name="t70_batch_lot_2_lateral-'.$c['id'].'" data-var="lateral" data-id="'.$c['id'].'" data-tab="2" value="'.$vars[3]['vars']['t70_batch_lot_2_lateral'].'"></td>
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_2_lateral'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_2_lateral-'.$c['id'].'" data-tab="2" data-var="lateral" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_2_lateral'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_2_lateral-'.$c['id'].'" data-tab="2" data-var="lateral" type=\'checkbox\'></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
			}
	...
	<div id="teamc" class="tab-pane fade no-padding">
	    <?php
			...
			<?
    			...
    			while($c = mysqli_fetch_assoc($q)) 
    			{
    			    ...
    			    echo '<tr>
    					...
    					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_main_risers'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_main_risers-'.$c['id'].'" data-tab="3" data-var="main_risers" type=\'checkbox\'></td>
    					<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_main_risers'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" data-tab="3" name="production_complete_3_main_risers-'.$c['id'].'" data-var="main_risers" type=\'checkbox\'></td>
    					<td align="center">'.$inspector_option.'</td>
    				</tr>';
    			}
			?>
...
//			$q = mysqli_query($link, 'SELECT * FROM projects WHERE pod LIKE \''.sf($pod).'%\' AND (product=1 OR product>=89) AND status!=\'deleted\' ORDER BY serial ASC');
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				if($c['product']==70) {
					...
					echo '<tr>
						...
						<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_mpc'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_mpc-'.$c['id'].'" data-tab="3" data-var="mpc" type=\'checkbox\'></td>
    					<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_mpc'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" data-tab="3" name="production_complete_3_mpc-'.$c['id'].'" data-var="mpc" type=\'checkbox\'></td>
    					<td align="center">'.$inspector_option.'</td>
					</tr>';
					...
					echo '<tr>
						...
						<td>'.$vars[2]['vars']['Main PC Handle Color 3'].'</td>
						<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_mpc'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_mpc-'.$c['id'].'" data-tab="3" data-var="mpc" type=\'checkbox\'></td>
    					<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_mpc'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_mpc-'.$c['id'].'" data-tab="3" data-var="mpc" type=\'checkbox\'></td>
    					<td align="center">'.$inspector_option.'</td>
					</tr>';
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_mpc_bridal'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_mpc_bridal-'.$c['id'].'" data-tab="3" data-var="mpc_bridal" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_mpc_bridal'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_mpc_bridal-'.$c['id'].'" data-tab="3" data-var="mpc_bridal" type=\'checkbox\'></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
			}
		...
		<table class="table">
			<tr>
				<th>Serial</th>
				<?php //while($c = mysqli_fetch_assoc($q)) { echo $c['product']; if($c['product'] != '96') {?>
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo'
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_rpc'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_rpc-'.$c['id'].'" data-tab="3" data-var="rpc" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_rpc'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_rpc-'.$c['id'].'" data-tab="3" data-var="rpc" type=\'checkbox\'></td>
    				<td align="center"><input size="6" type="text" class="field_update" name="rpc_batch_lot_3_rpc-'.$c['id'].'" data-var="rpc" data-id="'.$c['id'].'" data-tab="3" value="'.$vars[3]['vars']['rpc_batch_lot_3_rpc'].'"></td>
    				<td align="center"><input size="6" type="text" class="field_update" name="rpc_serial_3_rpc-'.$c['id'].'" data-var="rpc" data-id="'.$c['id'].'" data-tab="3" value="'.$vars[3]['vars']['rpc_serial_3_rpc'].'"></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
				}
			}
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_mdb'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_mdb-'.$c['id'].'" data-tab="3" data-var="mdb" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_mdb'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_mdb-'.$c['id'].'" data-tab="3" data-var="mdb" type=\'checkbox\'></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
			}
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_rf'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_rf-'.$c['id'].'" data-tab="3" data-var="rf" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_rf'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_rf-'.$c['id'].'" data-tab="3" data-var="rf" type=\'checkbox\'></td>
    				<td align="center"><input size="6" type="text" class="field_update" name="rf_batch_lot_3_rf-'.$c['id'].'" data-var="rf" data-id="'.$c['id'].'" data-tab="3" value="'.$vars[3]['vars']['rf_batch_lot_3_rf'].'"></td>
    				<td align="center"><input size="6" type="text" class="field_update" name="rf_serial_3_rf-'.$c['id'].'" data-var="rf" data-id="'.$c['id'].'" data-tab="3" value="'.$vars[3]['vars']['rf_serial_3_rf'].'"></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
			}
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td>'.$vars[1]['vars']['Hardware Type'].'</td>
					<td>'.$vars[1]['vars']['Yoke Size'].'</td>
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_rsl'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_rsl-'.$c['id'].'" data-tab="3" data-var="rsl" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_rsl'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_rsl-'.$c['id'].'" data-tab="3" data-var="rsl" type=\'checkbox\'></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
			}
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				if($air_snare == 'No' && $c['product'] == 96){ $air_snare = 'Yes'; }
				...
				echo '<td align="center">';
					if($air_snare != 'No'){
    					echo '<input value="'.$vars[3]['vars']['cut_ready_3_air_snare'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_air_snare-'.$c['id'].'" data-tab="3" data-var="air_snare" type=\'checkbox\' '.$readonly.'>';
					}
				echo '</td>
        			  <td align="center">';
        			if($air_snare != 'No'){
        			  echo '<input value="'.$vars[3]['vars']['production_complete_3_air_snare'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_air_snare-'.$c['id'].'" data-tab="3" data-var="air_snare" type=\'checkbox\' '.$readonly.'>';
    				}
    			echo '</td>';
    			echo '
    				<td align="center">'.$inspector_option.'</td>
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td>'.$vars[1]['vars']['Yoke Size'].'</td>
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_reserve_handle'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_reserve_handle-'.$c['id'].'" data-tab="3" data-var="reserve_handle" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_reserve_handle'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_reserve_handle-'.$c['id'].'" data-tab="3" data-var="reserve_handle" type=\'checkbox\'></td>
    				<td align="center"><input size="6" type="text" class="field_update" name="rh_batch_lot_3_reserve_handle-'.$c['id'].'" data-var="reserve_handle" data-id="'.$c['id'].'" data-tab="3" value="'.$vars[3]['vars']['rh_batch_lot_3_reserve_handle'].'"></td>
    				<td align="center">'.$inspector_option.'</td>
		...
		<table class="table">
			...
			while($c = mysqli_fetch_assoc($q)) {
				...
				echo '<tr>
					...
					<td></td>
					<td align="center"><input value="'.$vars[3]['vars']['cut_ready_3_mrh'].'" '.$cut_ready.' class="field_update" data-id="'.$c['id'].'" name="cut_ready_3_mrh-'.$c['id'].'" data-tab="3" data-var="mrh" type=\'checkbox\'></td>
    				<td align="center"><input value="'.$vars[3]['vars']['production_complete_3_mrh'].'" '.$production_complete.' class="field_update" data-id="'.$c['id'].'" name="production_complete_3_mrh-'.$c['id'].'" data-tab="3" data-var="mrh" type=\'checkbox\'></td>
    				<td align="center">'.$inspector_option.'</td>
				</tr>';
			}
