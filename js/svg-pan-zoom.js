...
module.exports = {
  enable: function(instance) {
    ...
    style.textContent = '.svg-pan-zoom-control { cursor: pointer; fill: black; fill-opacity: 0.2; padding: 10px;} .svg-pan-zoom-control:hover {cursor: pointer; fill-opacity: 1.0; } .svg-pan-zoom-control-background {cursor: pointer; fill: white; fill-opacity: 1.0; } .svg-pan-zoom-control-background:hover {cursor: pointer; fill-opacity: 1.0; }'
    ...
    zoomGroup.setAttribute('transform', 'translate(' + ( instance.width - 90 ) + ' ' + ( instance.height - 595 ) + ') scale(1.0)');
...
, _createZoomIn: function(instance) {
    ...
    zoomIn.setAttribute('transform', 'translate(30.5 5) scale(0.02)');
...
, _createZoomOut: function(instance){
    ...
    zoomOut.setAttribute('transform', 'translate(30.5 64) scale(0.02)');
